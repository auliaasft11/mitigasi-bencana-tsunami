...
# 1. Load the Dataset
df = pd.read_csv('C:/Users/ASUS/Downloads/mitigasi_final/mitigasi_final/kaggle/train.csv')
...
# 6. Save the Results
output_file = 'tsunami_clustering_output_kaggle.csv'
df[['id', 'text', 'cluster_label', 'cluster_name']].to_csv(output_file, index=False)
